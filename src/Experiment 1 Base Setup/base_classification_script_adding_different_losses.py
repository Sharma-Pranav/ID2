...
def train_test_loop(model, optimizer, num_epochs, trainloader, valloader, best_model_path = os.path.join("models", "best_model.pth") ):
...
if __name__ == '__main__':
    ...
    for i in range(n_splits):
        ...
        train_test_loop(model, optimizer, num_epochs, trainloader, valloader, best_model_path = os.path.join("models", "best_model.pth") )
        print(f"Finished Training fold : {i}")
        
        #print(f"best_accuracy achieved : {best_accuracy} fold : {i}")
